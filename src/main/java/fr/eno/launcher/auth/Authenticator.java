...
import fr.eno.launcher.auth.model.request.AuthRequest;
import fr.eno.launcher.auth.model.request.InvalidateRequest;
import fr.eno.launcher.auth.model.request.RefreshRequest;
import fr.eno.launcher.auth.model.request.SignoutRequest;
import fr.eno.launcher.auth.model.request.ValidateRequest;
import fr.eno.launcher.auth.model.response.AuthResponse;
import fr.eno.launcher.auth.model.response.RefreshResponse;
